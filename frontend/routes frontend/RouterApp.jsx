...
import { DeclaracionFondos } from "../pages/legal/DeclaracionFondos";
...
import AdminTrazabilidad from "../pages/trazabilidad_contabilidad/AdminTrazabilidad.jsx";
...
import AdminInventarioGeneral from "../Inventario-General/Admin/AdminInventarioGeneral.jsx";
import EmpleadoInventarioGeneral from "../Inventario-General/Empleado/EmpleadoInventarioGeneral.jsx";
...
export const routes = [
  // === RUTAS PÚBLICAS ===
  { path: "/", element: <Home /> },
  { path: "/admin-inventarios-generales", element: <AdminInventarioGeneral /> },
  {
  ...
  { path: "/declaracion-origen-fondos", element: <DeclaracionFondos /> },
  ...
  { path: "/reserva", element: <ReservaForm /> },
  {
    ...
    element: <NotificacionesElectronicas />,
  },
  ...
  // Rutas públicas de formularios sociodemográficos
  {
    ...
    element: <FormularioPerfilMerkahorro />,
  },
  {
    path: "/formularioperfilconstruahorro",
    element: <FormularioPerfilConstruahorro />,
  },
  {
    path: "/formularioperfilmegamayoristas",
    element: <FormularioPerfilMegamayoristas />,
  },

  // Rutas públicas de formularios de creación con token (para compartir externamente)
  ...
  // === RUTAS PROTEGIDAS ===
  {
    ...
    children: [
      ...
      {
        path: "/formulario-solicitud-personal",
        element: <FormularioSolicitudPersonal />,
      },
      ...
      },
      {
        ...
        children: [
          ...
          { path: "historial_completo", element: <HistorialActividadesPage /> }, // 🔒 Solo SST Admins
        ],
      },
      ...
      { path: "/admin-promociones", element: <AdminPromociones /> },
      ...
      // --- RUTAS DE TRAZABILIDAD CONTABILIDAD ---
      { path: "/trazabilidad/admin", element: <SuperAdminContabilidad /> },
      { path: "/trazabilidad/panel", element: <AdminTrazabilidad /> },
